...
local function BuildAWCEvents()
    return {
        {
            day = 1,
            start = UtcTime(2026, 9, 12, 0, 0, 0),
            finish = UtcTime(2026, 9, 12, 23, 59, 59),
        ...
        {
            day = 2,
            start = UtcTime(2026, 9, 13, 0, 0, 0),
            finish = UtcTime(2026, 9, 13, 23, 59, 59),
        ...
        {
            day = 3,
            start = UtcTime(2026, 9, 14, 0, 0, 0),
            finish = UtcTime(2026, 9, 14, 23, 59, 59),
